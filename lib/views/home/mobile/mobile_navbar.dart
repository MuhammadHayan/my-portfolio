  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: isDark ? null : AppColors.cardlightGradient,
        color: isDark
      ...
      child: AppBar(
        ...
        elevation: 4,
        backgroundColor:
            Colors.transparent, // gradient container handles background
  ...
  Widget build(BuildContext context) {
    ...
    return Drawer(
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: isDark
              ? null // keep dark theme simple
              : AppColors.containerlightGradient,
